...
def main():
    ...
    # image = Image.open('C:/Users/DELL/OneDrive/Desktop/F.jpg')
    # with title_container:
    #         with col1:
    #             st.image(image, width=300)
    #         with col2:
    #             st.markdown('<p class="big-font"><h1 style="color: red;"></h1></p>',
        ...
        if st.sidebar.checkbox("Login/Logout"):
            ...
            if result:
                ...
                with st.form(key='my_form'):
                    sc = col1.number_input("Enter Status Count")
                    fc = col2.text_input("Enter Followers Count")
                    frc = col1.text_input("Enter Friends Count")
